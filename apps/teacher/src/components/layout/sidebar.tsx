...
export const AdminSidebar = () => {
  ...
  return (
    <div className="w-64 fixed top-0 left-0 h-screen flex flex-col bg-linear-to-b from-edu-900 to-edu-800 dark:from-card dark:to-card shadow-2xl">
      ...
      <div className="p-3 border-t border-white/10 dark:border-white/5 shrink-0">
        <Button
          ...
          className="w-full justify-start h-10 rounded-lg font-medium text-sm text-edu-300 hover:text-white hover:bg-danger-500/20 transition-all duration-200 group"
        >
