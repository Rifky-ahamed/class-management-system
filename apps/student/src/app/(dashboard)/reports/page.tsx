...
import { MessageSquare, Plus, CheckCircle2, Clock, XCircle, AlertCircle, RefreshCw } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={fetchData} disabled={loading} className="rounded-xl h-10 w-10 p-0 sm:w-auto sm:px-4">
